...
class SimpleMCQExtractor:
    ...
    def process_paper(self, qp_path, ms_path, output_file):
        """Process a complete paper to extract Q&A with simple MCQ options"""
